...
import administrativos_interfaz_agregar_documentacion_alumno
...
class InterfaceDocumentacionAlumno(QWidget):
    ...
    def initUI(self,id):
        ...
        title = QLabel(f"Documentación del alumno - {datos[1]} {datos[2]} {datos[3]}")
        ...
        #Boton de regresar
        self.btn_regresar_control_alumnos = QPushButton()
        icono_regresar = QIcon('img/flecha-izquierda.png')
        self.btn_regresar_control_alumnos.setIcon(icono_regresar)
        aplicar_estilo_volver(self.btn_regresar_control_alumnos,"#FF5733")
