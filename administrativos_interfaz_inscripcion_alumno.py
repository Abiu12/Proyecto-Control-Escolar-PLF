...
from PyQt5.QtWidgets import QLineEdit,QFrame, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton,QSpacerItem,QSizePolicy,QGridLayout,QMessageBox,QWidget, QLineEdit
...
class InterfaceInscripcionAlumno(QWidget):
    ...
    def inscribirAlumno(self):
        ...
        if resultado:
            ...
            QMessageBox.critical(self, "Error", "No se pudo agregar el alumno")
